...
public class BouledeFeu extends Sort{
    ...
    public void lanceSort(Personnage persoAttaque, Magicien magicien)
    {
        if (magicien.getMagie()>=5)
        {
            ...
            System.out.println("Le Magicien " + magicien.type + " utilise le sort Boule de Feu, ce qui lui coûte " + getCout() + "pts de magie.");

            persoAttaque.setVie(persoAttaque.getVie()-5);
            ...
            System.out.println("Le Magicien " + magicien.type + " n'a pas assez de points magie pour lancer le sort Boule de Feu");
        }
    }
}
